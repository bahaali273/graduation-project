           ...
           class="btn-danger"/><br></div>     
            ...
            if (isset($_POST["s"])) {
                    ...
                    if ($con->connect_error) {
                        ...
                        ,companyName,Area,companyEmail,companyLocation,fax,phone,supervisorPhone,supervisorEmail,Trainingfield,AcademicSupervisor,pledge,Studentsignature
                        ,location,id_academicadvisor)
